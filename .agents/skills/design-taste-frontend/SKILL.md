...
description: High-agency frontend design taste rules (taste-skill v1 by Leonxlnx). Use when designing or refining UI - layout variance, typography, color calibration, motion, anti-AI-slop patterns.
---
