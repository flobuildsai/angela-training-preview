...
function FreePage() {
  ...
  return <main className="overflow-hidden bg-cream-paper text-near-black">
    ...
    <section className="relative mx-4 mb-4 overflow-hidden rounded-card text-pure-white"><img src={lauraWork.url} alt="Laura bei der Arbeit" className="absolute inset-0 h-full w-full object-cover" /><div className="absolute inset-0 bg-pressed-graphite/80" /><div className="relative mx-auto max-w-4xl px-5 py-24 text-center sm:px-8 sm:py-36"><p className="funnel-eyebrow text-pure-white/60">Dein nächster Schritt</p><h2 className="mt-5 text-[42px] font-medium leading-[1.02] sm:text-[64px]">Dein Content ist schon da. Jetzt kommt das System<span className="ember-dot">.</span></h2><p className="mx-auto mt-6 max-w-xl text-lg text-pure-white/70">Starte heute mit 22 Videos, sechs Modulen und deinem 30-Tage-Plan.</p><CTA onClick={openOptin} light /><p className="mt-10 text-sm text-pure-white/55">Schon dabei? <Link to="/kurs" className="underline underline-offset-4">Zum Kurs</Link></p></div></section>
